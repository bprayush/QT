...
#include "../Rectangle_Invaders/health.h"
...
const QMetaObject Health::staticMetaObject = {
    { &QGraphicsTextItem::staticMetaObject, qt_meta_stringdata_Health.data,
      qt_meta_data_Health,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
